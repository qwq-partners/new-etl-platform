...
| **`etl-platform-ui-information-architecture-v0.4.md`** | **Control Plane UI 정보구조 — 현행.** 화면 8개, Phase 0 표시 규칙, 두 UI 접합면, **§10 Advisor UX · §11 시각 표시 · §12 운영자 조회 · §13 목록 규모 · §14 인증·감사**. 미결 7건 중 **5건 해소**(남은 것: capability 표시·다국어), **A 공백 13건**(§9.1)을 A 개정 대상으로 분리 |
| `…-v0.3.md` · `-v0.2.md` · `-v0.1.md` | 이전 판. 이력으로 남긴다 |
