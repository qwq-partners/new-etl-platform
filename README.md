...
| **`…v1.2.3.1.md`** | **현행 최신 규범**(1,738줄). DBA 협조를 전제하므로 Profile O로 보존 |
...
| 게이트 | 파일 | 대상 | 안전 등급 |
|---|---|---|---|
| **G0-0A** | `g0-0a-capability-inventory.sql` | 계정 권한·capability 실측(56 probe) | 운영계 가능(대상 테이블 스캔 없음) |
